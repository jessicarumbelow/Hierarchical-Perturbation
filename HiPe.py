...
def hierarchical_perturbation(model, input, interp_mode='nearest', resize=None, perturbation_type='fade',
    ...
    with torch.no_grad():
        ...
        depth_saliency = torch.zeros((max_depth+1, num_classes, input_y_dim, input_x_dim), device=dev)
        ...
        if depth_sal:
            return saliency, depth_saliency, total_masks
